...
public class LoginExceptionHandler {
    ...
    ResponseEntity<ApiError> loginRejected(HttpServletRequest request) {
        return response(request, HttpStatus.UNAUTHORIZED, "INVALID_CREDENTIALS",
                "Email or password is invalid.", List.of());
    }
